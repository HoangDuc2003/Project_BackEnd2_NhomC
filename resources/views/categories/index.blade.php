                            ...
                            <table class="table">
                                ...
                                @foreach($categories as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/categories/' . $item->id . '/edit') }}" title="Edit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
