                ...
                <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                    <div class="primary-menu">
                        <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                            <li class="menu-item"><a href="{{ url('/fontend') }}">Home</a></li>
                            <li class="menu-item menu-item-has-children has-child">
                                <a href="#" class="menu-name" data-title="Products">Movie</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="#">Now Showing</a></li>
                                    <li class="menu-item"><a href="#">Coming Soon</a></li>
                                </ul>
                            </li>
                            <li class="menu-item menu-item-has-children has-megamenu">
                                <a href="#" class="menu-name" data-title="Demo">Cinema</a>
                                    ...
                                    <div class="mega-content">
                                        <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                            <div class="wrap-custom-menu vertical-menu">
                                                <h4 class="menu-title">Cinema Page</h4>
                                                <ul class="menu">
                                                    @foreach
                        ...
                        <div class="mobile-search">
                            ...
                            <div class="mobile-search-content">
                                <form action="#" class="form-search" name="mobile-seacrh" method="get">
                                    ...
                                    <input type="text" name="key" class="input-text" value="" placeholder="Search here...">
